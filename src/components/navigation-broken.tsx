...
export default function Navigation() {
  ...
  // Set CSS custom properties for mobile menu
  useEffect(() => {
    const root = document.documentElement
    if (theme === 'dark' || isDark) {
      root.style.setProperty('--mobile-menu-bg', '#1e293b')
      root.style.setProperty('--mobile-menu-text', '#f1f5f9')
    } else {
      root.style.setProperty('--mobile-menu-bg', '#ffffff')
      root.style.setProperty('--mobile-menu-text', '#0f172a')
    }
  }, [theme, isDark])
